...
namespace JJSolutions.TableList.AspNet.TagHelper
{
    public class RenderSearch
    {
        ...
        {
            return _parentContext.AspAction.IndexOf("?", StringComparison.Ordinal) == -1 ? $"/{_parentContext.AspController}/{_parentContext.AspAction}?searchString=" : $"/{_parentContext.AspController}/{_parentContext.AspAction}&searchString=";
        }
    }
}